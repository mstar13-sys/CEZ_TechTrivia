...
<div class="main-content">
    ...
    <div class="cards-grid">
        <div class="card" onclick="window.location.href='../controllers/QuizController.php?action=start'">
...
document.addEventListener('DOMContentLoaded', () => {
    Swal.fire({ icon:'success', title:'Done!', text:<?= json_encode($flash_success) ?>, background:'#1a1830', color:'#f1f0ff', confirmButtonColor:'#4f46e5' });
});
</script>
<?php endif; ?>
<?php if ($flash_error): ?>
<script>
document.addEventListener('DOMContentLoaded', () => {
    Swal.fire({ icon:'error', title:'Error', text:<?= json_encode($flash_error) ?>, background:'#1a1830', color:'#f1f0ff', confirmButtonColor:'#4f46e5' });
});
</script>
<?php endif; ?>
</body>
