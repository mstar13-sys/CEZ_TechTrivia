...
<head>
    ...
    <style>
        ...
        .lb-row.lb-top td:first-child { font-size: 1.2rem; }
        .lb-avatar {
            display: inline-flex;
            align-items: center;
        ...
        .lb-xp { color: #4f46e5; font-weight: 600; }
...
<body>
    ...
    <section id="home">
        ...
        <div class="hero-image">
            <img src="assets/image/bg.png" alt="Picture Putek" class="laptop-mockup">
        </div>
    </section>
                    ...
                    <div class="tmember" data-idx="0">
                        ...
                        <div class="t-hover-card">
                            ...
                            <div class="t-hc-info">
                                ...
                                <span>Backend / API Programmer</span>
                            </div>
                        </div>
                    </div>
