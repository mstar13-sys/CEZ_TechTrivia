...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fUsername.addEventListener('input', () => {
        ...
        userTimer = setTimeout(async () => {
            try {
                const res = await fetch(`../api/check_availability.php?field=username&value=${encodeURIComponent(v)}`);
    ...
    fEmail.addEventListener('input', () => {
        ...
        emailTimer = setTimeout(async () => {
            try {
                const res = await fetch(`../api/check_availability.php?field=email&value=${encodeURIComponent(v)}`);
                const data = await res.json();
